...
export default function SkillsSlider() {
  return (
    <section
      id="skills"
      className="py-20 bg-gray-900 text-gray-300 overflow-hidden border-t border-slate-700"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        ...
        <p className="text-xl text-slate-300 text-center max-w-3xl mx-auto mb-8">
          Expertise in modern technologies with focus on MERN stack, AI/ML, and
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-slate-400 max-w-3xl mx-auto">
            Comprehensive expertise across modern web development and machine
